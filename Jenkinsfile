...
node () {
    ...
    stage('Deploy') {
       steps {
     ps msdeploy -verb:sync -source:contentPath=C:\Users\Administrator\source\repos\Blogifier\src\Blogifier\bin\Debug\net5.0\publish -dest:contentPath=C:\ProgramFiles\IIS\aspweb
    }  
}
